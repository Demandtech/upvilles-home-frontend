		...
		<div className="bg-white shadow-lg shadow-default-100 rounded-lg py-10 px-5">
			...
			<div>
				<div className="flex gap-5 flex-wrap mb-10">
					<div className="relative flex-1 py-7 px-10 rounded-md shadow-md shadow-default-100 bg-lightBg border border-[#EEEEEE]">
						<div>
					...
					<div className="relative flex-1 py-7 px-10 bg-lightBg shadow-md shadow-default-100 rounded-md border border-[#EEEEEE]">
						<div>
					...
					<div className="bg-lightBg relative px-10 py-7 shadow-md shadow-default-100 rounded-md flex-1 border border-[#EEEEEE]">
						<div>
							<h6 className="text-2xl mb-1 font-semibold text-nowrap">
