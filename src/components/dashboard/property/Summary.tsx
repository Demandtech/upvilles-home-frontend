  ...
  return (
    <div className="py-5 sm:py-8 px-3 sm:px-5">
      <div className="grid grid-cols-6 gap-2 items-center">
        ...
        <div className="space-y-1 sm:space-y-3 col-span-3 lg:col-span-1 text-white p-4 rounded-xl bg-[#8BB6A2] shadow-sm">
          <TotalHousesIconSvg className="w-6 sm:w-7" />
          <p className="text-xs text-[#f0e7e7]">Total Houses</p>

          <Counter labelColor="white" targetNumber={stats?.total_properties} />
        </div>
        <div className="space-y-1 sm:space-y-3 col-span-3 lg:col-span-1 p-4 text-white rounded-xl bg-[#4D4E8E] shadow-sm">
          <TotalTenantsIconSvg className="w-6 sm:w-7" />
          <p className="text-xs text-[#f0e7e7]">Total Tenants</p>
          <Counter labelColor="white" targetNumber={stats?.total_tenants} />
        </div>
        <div className="space-y-1 sm:space-y-3 col-span-3 lg:col-span-1 p-4 text-white rounded-xl bg-[#636D79] shadow-sm">
          <OccupiedUnitsIconSvg className="w-6 sm:w-7" />
          <p className="text-xs text-[f0e7e7]">Occupied Units</p>
          <Counter labelColor="white" targetNumber={stats?.occupied_units} />
        </div>
        <div className="space-y-1 sm:space-y-3 col-span-3 lg:col-span-1 p-4 text-white rounded-xl bg-[#284B63] shadow-sm">
          <VacantUnitIconSvg className="w-6 sm:w-7" />
