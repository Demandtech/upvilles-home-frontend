...
function SupportChat({
  ...
  const handleSubmit = useCallback(
    (event: FormEventHandler<HTMLFormElement>): void => {
  ...
  return (
    <div className="bg-white h-full lg:rounded-t-lg shadow-lg shadow-default-100 min-h-96 lg:max-h-[700px] overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="mt-auto">
          <div className="relative min-h-12 flex">
            <textarea
              ...
              className=" resize-none w-full bg-primary-50 min-h-12 focus-within:outline focus:outline-none p-3"
