      ...
      <ul className="space-y-4">
        <li className="flex gap-3 md:gap-4">
          ...
          <div>
            ...
            <p className="text-darkGrey max-w-sm text-sm md:text-base">
              Send us a message at{" "}
              <span className="text-primary">support@example.com</span>, and our
        ...
        <li className="flex gap-3 md:gap-4">
          ...
          <div>
            ...
            <p className="text-darkGrey max-w-sm text-sm md:text-base">
              If you prefer to visit us in person or send physical mail, you can
              find us at: 1, Isheri North GRA, Opic Berger, Lagos
            </p>
          </div>
        </li>
        <li className="flex gap-3 md:gap-4">
