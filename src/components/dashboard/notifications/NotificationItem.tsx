...
function NotificationItem({ item }: { item: Notification }) {
	return (
		<div className="py-5 min-h-[100px] last-of-type:border-b-0 px-5 md:px-10 gap-2 md:gap-10 flex flex-col md:flex-row border-b border-[#F0F2F5] hover:bg-[#f0f2f5] transition-background ease-linear duration-300">
			<div className="flex gap-5 sm:items-center w-full">
				<div>
					<NotificationIcon
						className="h-7 w-7 sm:w-14 sm:h-14 "
						color={item.is_read ? "white" : "#FF3B30"}
					/>
				</div>
				<div className="">
